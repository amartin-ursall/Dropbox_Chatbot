...
export function LoginScreen({ onLoginSuccess }: LoginScreenProps) {
  const handleLogin = () => {
    // Get backend URL from environment or use domain-based URL for network access
    const backendUrl = import.meta.env.VITE_BACKEND_URL || 'http://dropboxaiorganizer.com:8000'
